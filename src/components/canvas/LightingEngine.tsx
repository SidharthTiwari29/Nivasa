...
export function LightingEngine() {
  ...
  const ambientRef = useRef<AmbientLightProxy>(null);
  ...
  return (
    <>
      <ambientLight ref={ambientRef as never} intensity={LIGHT_TARGETS.morning.ambientIntensity} />
      <directionalLight
        ref={sunRef}
        castShadow
...
type AmbientLightProxy = { intensity: number };
