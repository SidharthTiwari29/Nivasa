...
export function assertExperienceWeights(weights: ExperienceWeights): void {
  ...
  if (total !== 10_000)
    throw new Error("experience weights must total 10000 basis points");
  if (
    ...
    throw new Error(
      "experience weights must be integer basis points between 0 and 10000",
    );
  }
}
