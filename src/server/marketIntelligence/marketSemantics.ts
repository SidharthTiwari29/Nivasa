...
const UNIT_ALIASES: Record<string, NormalizedUnit> = {
  ...
  l: "l", litre: "l", liter: "l", litres: "l", liters: "l", ml: "ml",
  ...
  m: "m", metre: "m", meter: "m", metres: "m", meters: "m", cm: "cm", centimetre: "cm", centimeter: "cm", centimetres: "cm", centimeters: "cm",
};
...
const SCALE_TO_BASE: Record<NormalizedUnit, number> = {
  unit: 1, piece: 1, set: 1, box: 1, pack: 1, kg: 1, g: 0.001, l: 1, ml: 0.001,
  sqft: 1, sqm: 10.763910416709722, m: 1, cm: 0.01,
};
...
export const normalizeQuantity = (quantity: number, from: string, to: NormalizedUnit): number => {
  ...
  if (dimensionGroup(source) !== dimensionGroup(to)) throw new Error(`Incompatible market units: ${source} -> ${to}`);
